...
| 工程名 | 类型 | 仓库地址 | 主分支 | 分支策略 | 本地路径 | 职责边界 |
|-------|------|---------|--------|---------|---------|---------|
| <!-- 如：web-frontend --> | <!-- 前端 / 后端 / 全栈 / 移动端 / 微服务 --> | <!-- git@... 或「待创建」--> | main | 见 `standards/engineering/standards.md` | `engineering/workspace/<工程名>/` | <!-- 一句话说明本工程负责什么 --> |
